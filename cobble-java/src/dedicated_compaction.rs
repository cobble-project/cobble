...
fn open_scan(env: &mut JNIEnv, config: cobble::Config, root: String) -> jlong {
...
fn open_watch(env: &mut JNIEnv, config: cobble::Config, paths: Vec<String>) -> jlong {
...
fn open_executor(env: &mut JNIEnv, config: cobble::Config) -> jlong {
...
fn decode_config(env: &mut JNIEnv, config_json: JString) -> Option<cobble::Config> {
...
fn decode_config_path(env: &mut JNIEnv, config_path: JString) -> Option<cobble::Config> {
    ...
    match cobble::Config::from_path(path) {
