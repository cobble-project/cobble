...
```bash
java -jar cobble-0.3.0.jar --help
java -jar cobble-0.3.0.jar remote-compactor --config ./config.yaml --bind 127.0.0.1:18888
java -jar cobble-0.3.0.jar web-monitor --config ./config.yaml --bind 127.0.0.1:8080
```
