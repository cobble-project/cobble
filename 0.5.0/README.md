...
2. Push a version tag with `v` prefix (e.g. `v0.5.0`) -> publish `<version>/` (e.g. `0.5.0/`)
...
2. For versioned docs: create and push a version tag (e.g. `v0.5.0`).
...
- `<semver>/` (for released docs, e.g. `0.5.0/`)

Example URLs:

- `https://cobble-project.github.io/cobble/latest/`
- `https://cobble-project.github.io/cobble/0.5.0/`
